            ...
            <div class="card-body">
                <form method="post" action="{{ route('santri.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputText3" type="text" class="form-control" name="nisn">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputText3" type="text" class="form-control" name="tempat_lahir">
                    </div>
                    <div class="form-group">
                        <label for="inputText3" class="col-form-label">Tanggal lahir</label>
                        <input id="inputText3" type="date" class="form-control" name="tanggal_lahir">
                    </div>
                    <div class="form-group">
