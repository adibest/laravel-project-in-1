...
<div class="row">
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('pengguna.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputText3" type="email" class="form-control" name="email" value="{{ old('email') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputText3" type="password" class="form-control" name="password" value="{{ old('password') }}">
        ...
        <div><a href="{{ url('/pengguna') }}" class="btn btn-secondary text-right">Kembali</a></div>
    </div>
</div>
